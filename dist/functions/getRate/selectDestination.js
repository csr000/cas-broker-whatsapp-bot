...
function selectDestination(_x, _x2, _x3, _x4) {
  return _selectDestination.apply(this, arguments);
}
function _selectDestination() {
  _selectDestination = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(recipientPhone, textMessage, res, message_id) {
                ...
                while (1) switch (_context3.prev = _context3.next) {
                  ...
                  case 2:
                    ...
                    _db["default"].query("SELECT destination_region FROM whatsapp_cloud WHERE phone_no = '".concat(recipientPhone, "'"), /*#__PURE__*/function () {
                      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(err, rows, fields) {
                          ...
                          while (1) switch (_context2.prev = _context2.next) {
                            ...
                            case 2:
                              _db["default"].query("SELECT name FROM destinationrates WHERE region_id = '".concat(rows[0].destination_region, "'"), /*#__PURE__*/function () {
                                var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(err, rows, fields) {
                                  var i;
                                    ...
                                    while (1) switch (_context.prev = _context.next) {
                                      ...
                                      case 2:
                                        ...
                                        for (i = 0; i < rows.length; i++) {
                                          message = message.concat("".concat(i + 1, ". ").concat((0, _routes.titleCase)(rows[i].name.toLowerCase()), "\n"));
                                        }
                                        console.log(res);
                                        _context.next = 7;

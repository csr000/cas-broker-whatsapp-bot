...
exports["default"] = selectContainerNum;
...
function selectContainerNum(_x, _x2, _x3, _x4) {
  return _selectContainerNum.apply(this, arguments);
}
function _selectContainerNum() {
  _selectContainerNum = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(recipientPhone, textMessage, message_id, res) {
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _db["default"].query("SELECT latest_question FROM whatsapp_cloud WHERE phone_no = '".concat(recipientPhone, "'"), /*#__PURE__*/function () {
            var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(err, rows, fields) {
              var latest_question;
              return _regeneratorRuntime().wrap(function _callee4$(_context4) {
                while (1) switch (_context4.prev = _context4.next) {
                  case 0:
                    ...
                    throw err;
                  case 2:
                    latest_question = rows[0].latest_question;
...
function ncAction(message, recipientPhone) {
  ...
  _db["default"].query("SELECT * FROM whatsapp_cloud WHERE phone_no = '".concat(recipientPhone, "'"), /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(err, rows, fields) {
          ...
          case 2:
            ...
            if (container_type === 'container_20') {
              _db["default"].query("SELECT rate_twenty FROM destinationrates WHERE region_id = '".concat(destination_region, "' AND name = '").concat(pickup_destination, "'"), /*#__PURE__*/function () {
                var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(err, rows, fields) {
                  var rate;
...
//# sourceMappingURL=selectContainerNum.js.map
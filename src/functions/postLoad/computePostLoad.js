...
export default async function computePostLoad(params) {
  ...
  await selectTransactionType( typeOfMsg,
    buttonReplyID,recipientPhone, message_id, res);
  ...
  await enterNumberOfTruckNeeded(recipientPhone, textMessage, res, message_id);
